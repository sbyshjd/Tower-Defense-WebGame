...
let placeTowerMusic = document.getElementById('place-tower')
let sellTowerMusic = document.getElementById('sell-tower')
let basicShoot = document.getElementById('basic-shoot')
let megaShoot = document.getElementById('mega-shoot')
console.log(placeTowerMusic)
...
class Game {
    ...
    gameUpdate() {
        ...
        //background music play witt the start-page game-page and the end-page
